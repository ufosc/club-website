			...
			<div className="tempWrapper">
				<div id="about" className="page-element">
					...
					<p className="text">
						...
						<br /> <br />
						To learn how to get involved, check out the <a href="https://github.com/ufosc/getting-started">getting started
							guide</a>.
					</p>
				</div>
				...
				<div id="meetings" className="page-element">
					...
					<p className="text">
						We have a couple types of meetings. Check our <a href="https://www.facebook.com/groups/ufosc/">Facebook</a> for
						times and locations.
						<ol className="text">
				...
				<div id="history" className="page-element">
					...
					<div className="text">
						Through Fall of 2018 the Open Source Club has kept a simmilar format, while experimenting with a new type of
						meetings called Code Jams. The goal was to provide a longer workshop where students could come to learn about a
